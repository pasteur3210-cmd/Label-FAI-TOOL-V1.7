# Label Auto Inspection Tool V1.9.17

## V1.9.17 Factory Manual Completion + Password Rule Hotfix
...
## V1.9.17 Deterministic Golden Reference + Manual-First Validation
...
## V1.9.17 Form-Driven Multi-Golden Factory Release
...
## V1.9.17 Final Label + Item Specification Manual Review Fix
...
## V1.9.17 Factory Validation Release
...
Release gates cover Dynamic Golden completeness, mandatory Barcode/QR non-bypass, stale-profile isolation, QR fusion, operator-attention traceability, Python 3.11 compatibility, package hygiene, and the V1.9.17 strict Artwork ROI safety regression.

## V1.9.17 Manual Review Responsive UI Hotfix
...
## V1.9.17 Operator-Attention + Clean Golden Reload Integration
...
Automatic OCR, barcode, artwork, evidence fusion, incremental cache and automatic PASS/FAIL behavior remain covered by the existing regression suite. V1.9.17 adds dedicated tests for all-non-PASS operator attention, review-only protection, stale Golden asset removal, and Profile/Golden session invalidation.
